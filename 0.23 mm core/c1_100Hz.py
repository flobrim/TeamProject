...
df_1 = base_code1.read_in_files(file_path="/Users/student/Library/CloudStorage/OneDrive-DurhamUniversity/Team project/TeamRepo/TeamProject-1/100_1/*.csv",
                        f=100, # Change this 
...
df_2 = base_code1.B_H_calculation(df=df_1,
                            ...
                            l=0.32,
                            l_error=0.01,
                            thi=22*np.pi/90) # Change this

final_answer = base_code1.B_H_plotter(df=df_2,
                     show=True,
                     freq=100, # Change this 
                     freq_error=0.0001,
                     A=8.93e-4,
                     A_error=1e-4,
                     l=0.32,
